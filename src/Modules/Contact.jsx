    ...
    <>
      ...
      <Container className={`${textContainerWidthClass} mt-5 float-md-right text-right mr-lg-5`}>
        ...
        <div className="mt-3 mb-3 pr-lg-5 pr-xs-3">
          <Button className="contact-btns bg-customBlue mr-2 shadow border-0 py-1" onClick={() => window.open('https://www.linkedin.com/in/rohit-pal-246aa1241/', '_blank')}>
            <FontAwesomeIcon size="1x" icon={faLinkedinIn} /><span style={{}}>Linkedin</span>
          </Button>
          <Button className="contact-btns bg-customBlue mr-2 shadow border-0 py-1" onClick={() => window.open('', '_blank')}>
            <FontAwesomeIcon size="1x" icon={faFacebookF} /><span>Facebook</span>
          </Button>
          <Button className="contact-btns bg-customBlue mr-2 shadow border-0 py-1 px-2" onClick={() => window.open('', '_blank')}>
            <FontAwesomeIcon size="1x" icon={faTwitter} /><span>Twitter</span>
          </Button>
          <Button className="contact-btns bg-customBlue shadow border-0 py-1 px-2" onClick={() => window.open('mailto:rohitpal23478@gmail.com?subject="Hello !"', '_blank')}>
