            ...
            <div className={`my-auto ${width > 760 ? 'w-50' : ''}`}>
              <div>
                <div className="">
                  ...
                  <span className="color-customBlue h1 font-weight-bold">I'm Rohit Pal</span><br />
                ...
                <div>
                  <div className="d-flex mt-4">
                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/rptomar" className="color-customBlue p-0 mr-3"><FontAwesomeIcon size="2x" icon={faGithubSquare} /></a>
                    <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/rohit-pal-246aa1241/" className="color-customBlue p-0 mr-3"><FontAwesomeIcon size="2x" icon={faLinkedin} /></a>
                    <a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/users/20799746/rohit-pal" className="color-customBlue p-0 mr-3"><FontAwesomeIcon size="2x" icon={faStackOverflow} /></a>
                  </div><br />
